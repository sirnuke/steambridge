...
#define __CANT_IMPLEMENT_ARGS__(ARGS, ...) { __cant_implement__(__FUNCSIG__, ARGS, __VA_ARGS__); }
...
#define __LOG_ARGS_MSG__(MSG, ARGS, ...) __log_message__(__FUNCSIG__, MSG, ARGS, __VA_ARGS__)
