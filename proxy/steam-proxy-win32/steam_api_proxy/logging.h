...
#define __LOG(MSG)  __log_message__(__FUNCSIG__, MSG, "")
#define __LOG(MSG, ARGS, ...) __log_message__(__FUNCSIG__, MSG, ARGS, \
    __VA_ARGS__)
void __log__(const char *func, const char *msg, const char *args, ...);
