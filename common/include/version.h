// version.h - Defines the SteamBridge version
//
// CRITICAL: This file is shared between the win32 Visual Studio proxy
//           project, and the Linux Winelib bridge.  Any changes must
//           be reflected in both.

#ifndef  ___STEAM_API_BRIDGE_VERSION_H___
#define  ___STEAM_API_BRIDGE_VERSION_H___
